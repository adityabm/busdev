...
<body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="navbar-header navbar-header-custom">
                            ...
                            <a class="navbar-logo" href="index.html"><img src="img/logos/logo.png" alt="logo" id="logo"></a>
                        </div>
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right navbar-links-custom">
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">About</a>
                                    <ul class="dropdown-menu dropdown-menu-left">
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services</a>
                                    <ul class="dropdown-menu dropdown-menu-left">
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Projects</a>
                                    <ul class="dropdown-menu dropdown-menu-left">
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Blog</a>
                                    <ul class="dropdown-menu dropdown-menu-left">
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Shop</a>
                                    <ul class="dropdown-menu dropdown-menu-left">
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
                                    <ul class="dropdown-menu dropdown-menu-left">
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Elements</a>
                                    <ul class="dropdown-menu dropdown-menu-left">
                                ...
                                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Contact</a>
    ...
    <div class="main-image-section" style="background-image:url(img/slider/slide22.jpg);">
        <div class="main-image-content">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-xs-12 col-md-offset-2">
                        <div class="center-holder">
                            <h2> Think Ahead and Boost Your Online Business Growth </h2> </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3">
                        <div class="center-holder">
                            <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo. </p>
                            <div class="mt-30"> <a href="#contact" class="primary-button button-md">Lean More</a> </div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="pr-30-md">
                        <div class="section-heading">
                            <h4>Smart Solutions For Your Business</h4> </div>
                        <div class="section-heading-line-left"></div>
                        ...
                        <div class="mt-20">
                            <ul class="primary-list">
                                ...
                                <li><i class="fa fa-caret-right"></i>Employment consultant Environmental consultant</li>
                            </ul>
                        </div>
                        <div class="mt-25"> <a href="#" class="primary-button button-sm mb-15-xs">Contact Us</a> </div>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12"> <img src="img/content/home13.jpg" class="rounded-border shadow-primary" alt="img"> </div>
            </div>
        </div>
    </div>
    ...
    <div class="section-block-bg" style="background-image: url(img/bg/bg17.jpg);">
        <div class="container">
            <div class="section-heading center-holder white-color"> <span>Gain a Success With Us!</span>
                <h2><strong>We Provide Solutions To Grow</strong></h2>
                <h3>Your Business Faster</h3> <a href="#" class="primary-button button-md mt-10">Become a Client</a> </div>
        </div>
    </div>
    <div class="section-block-grey">
        <div class="container">
            <div class="section-heading left-holder">
                <h2 class="text-semi-bold">Our Services</h2>
                <div class="section-heading-line-left"></div>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                    <br>incididunt ut labore et dolore magna aliqua.</p>
            </div>
            <div class="row mt-40">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="services-box-3">
                        <div class="services-box-3-header"> <span>Consulting</span>
                            <h4><a href="#">Software and Research</a></h4> </div><img src="img/content/services/serv-1.jpg" alt="img"> </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="services-box-3">
                        <div class="services-box-3-header"> <span>Finances</span>
                            <h4><a href="#">Financial Planning</a></h4> </div><img src="img/content/services/serv-2.jpg" alt="img"> </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="services-box-3">
                        <div class="services-box-3-header"> <span>Business</span>
                            <h4><a href="#">Business Strategy</a></h4> </div><img src="img/content/services/serv-3.jpg" alt="img"> </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="services-box-3">
                        <div class="services-box-3-header"> <span>Consulting</span>
                            <h4><a href="#">Turnaround Consulting</a></h4> </div><img src="img/content/services/serv-4.jpg" alt="img"> </div>
                </div>
            </div>
            <div class="mt-40 center-holder"> <a href="#" class="button-md primary-button">View all Services</a> </div>
        </div>
    </div>
    <div class="section-block">
        <div class="container">
            ...
            <div class="owl-carousel owl-theme mt-30" id="testmonial-item">
                <div class="testmonial-item">
                    ...
                    <div class="testmonial-item-bxx-img">
                        <div class="testmonial-item-img"> <img src="img/testmonials/t-1.jpg" alt="img"> </div>
                        <div class="testmonial-item-name">
                            <h4>Henry Ford</h4> <span>Financial Analyst</span> </div>
                    </div>
                </div>
                <div class="testmonial-item">
                    <div class="testmonial-item-bxx">
                    ...
                    <div class="testmonial-item-bxx-img">
                        <div class="testmonial-item-img"> <img src="img/testmonials/t-2.jpg" alt="img"> </div>
                        <div class="testmonial-item-name">
                            <h4>Jason Smith</h4> <span>Consultant</span> </div>
                    </div>
                </div>
                <div class="testmonial-item">
                    <div class="testmonial-item-bxx">
                    ...
                    <div class="testmonial-item-bxx-img">
                        <div class="testmonial-item-img"> <img src="img/testmonials/t-3.jpg" alt="img"> </div>
                        <div class="testmonial-item-name">
                            <h4>Jasmin Priestley</h4> <span>Company Owner</span> </div>
                    </div>
                </div>
                <div class="testmonial-item">
                    <div class="testmonial-item-bxx">
                    ...
                    <div class="testmonial-item-bxx-img">
                        <div class="testmonial-item-img"> <img src="img/testmonials/t-4.jpg" alt="img"> </div>
                        <div class="testmonial-item-name">
                            <h4>Michelle Stacey</h4> <span>Consultant</span> </div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="mt-25">
                        <div class="footer-recent-post clearfix">
                            ...
                            <div class="footer-recent-post-content"> <span>February 7, 2018</span> <a href="#">Advices for young designers</a> </div>
                        </div>
                        <div class="footer-recent-post clearfix">
                            <div class="footer-recent-post-thumb"> <img src="img/thumbs/t-2.jpg" alt="img"> </div>
                            <div class="footer-recent-post-content"> <span>February 7, 2018</span> <a href="#">What Planning Process Needs?</a> </div>
                        </div>
                        <div class="footer-recent-post clearfix">
                            <div class="footer-recent-post-thumb"> <img src="img/thumbs/t-3.jpg" alt="img"> </div>
                            <div class="footer-recent-post-content"> <span>February 7, 2018</span> <a href="#">Lorem ipsum dolor sit amet.</a> </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <h3>Tags</h3>
                    <div class="footer-tags mt-25"> <a href="#">Business</a> <a href="#">Conusltant</a> <a href="#">Coach</a> <a href="#">UX</a> <a href="#">API</a> <a href="#">Reputation</a> <a href="#">Research</a> <a href="#">Sale</a> <a href="#">Service</a> <a href="#">UI</a> <a href="#">Web</a> <a href="#">WebDesign</a> </div>
                </div>
            </div>
